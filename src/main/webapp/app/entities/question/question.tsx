            ...
            <Table responsive>
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={this.sort('ask')}>
                    Ask <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('answersAs')}>
                    Answers As <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('minNumOptions')}>
                    Min Num Options <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
